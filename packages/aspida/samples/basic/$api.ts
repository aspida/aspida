...
import type { Methods as Methods_1glcnby } from './polymorphism/get';
...
const api = <T>({ baseURL, fetch }: AspidaClient<T>) => {
  ...
  return {
    ...
    polymorphism: {
      get: {
        get: (() => {
          function getRequest(option: { query: Methods_1glcnby['get']['polymorph'][0]['query'], config?: T | undefined }): Promise<AspidaResponse<Methods_1glcnby['get']['polymorph'][0]['resBody']>>
          function getRequest(option: { query: Methods_1glcnby['get']['polymorph'][1]['query'], config?: T | undefined }): Promise<AspidaResponse<Methods_1glcnby['get']['polymorph'][1]['resBody']>>
        ...
        $get: (() => {
          function $getRequest(option: { query: Methods_1glcnby['get']['polymorph'][0]['query'], config?: T | undefined }): Promise<Methods_1glcnby['get']['polymorph'][0]['resBody']>
          function $getRequest(option: { query: Methods_1glcnby['get']['polymorph'][1]['query'], config?: T | undefined }): Promise<Methods_1glcnby['get']['polymorph'][1]['resBody']>
          function $getRequest(option: any) {
    ...
    v1_1: {
      $2: {
        ...
        _hogeId_string: (val2: string) => {
          ...
          return {
            entries_json: {
              get: (option?: { config?: T | undefined } | undefined) =>
                fetch<Methods_1cro2gr['get']['resBody']>(prefix, `${prefix2}${PATH5}`, GET, option).json(),
              $get: (option?: { config?: T | undefined } | undefined) =>
                fetch<Methods_1cro2gr['get']['resBody']>(prefix, `${prefix2}${PATH5}`, GET, option).json().then(r => r.body),
            ...
            test_4: {
              ...
              fuga_aa: {
                get: (option: { query: Methods_1bmleo0['get']['query'], config?: T | undefined }) =>
                  fetch<Methods_1bmleo0['get']['resBody']>(prefix, `${prefix2}${PATH7}`, GET, option).json(),
                $get: (option: { query: Methods_1bmleo0['get']['query'], config?: T | undefined }) =>
                  fetch<Methods_1bmleo0['get']['resBody']>(prefix, `${prefix2}${PATH7}`, GET, option).json().then(r => r.body),
                post: (option: { body?: Methods_1bmleo0['post']['reqBody'] | undefined, query: Methods_1bmleo0['post']['query'], config?: T | undefined }) =>
                  fetch<Methods_1bmleo0['post']['resBody']>(prefix, `${prefix2}${PATH7}`, POST, option).json(),
                $post: (option: { body?: Methods_1bmleo0['post']['reqBody'] | undefined, query: Methods_1bmleo0['post']['query'], config?: T | undefined }) =>
                  fetch<Methods_1bmleo0['post']['resBody']>(prefix, `${prefix2}${PATH7}`, POST, option).json().then(r => r.body),
                put: (option: { query: Methods_1bmleo0['put']['query'], config?: T | undefined }) =>
                  fetch<Methods_1bmleo0['put']['resBody']>(prefix, `${prefix2}${PATH7}`, PUT, option).json(),
                $put: (option: { query: Methods_1bmleo0['put']['query'], config?: T | undefined }) =>
                  fetch<Methods_1bmleo0['put']['resBody']>(prefix, `${prefix2}${PATH7}`, PUT, option).json().then(r => r.body),
                delete: (option: { body: Methods_1bmleo0['delete']['reqBody'], query: Methods_1bmleo0['delete']['query'], config?: T | undefined }) =>
                  fetch<Methods_1bmleo0['delete']['resBody']>(prefix, `${prefix2}${PATH7}`, DELETE, option).json(),
                $delete: (option: { body: Methods_1bmleo0['delete']['reqBody'], query: Methods_1bmleo0['delete']['query'], config?: T | undefined }) =>
                  fetch<Methods_1bmleo0['delete']['resBody']>(prefix, `${prefix2}${PATH7}`, DELETE, option).json().then(r => r.body),
              ...
              put: (option?: { query?: Methods_1dirya6['put']['query'] | undefined, config?: T | undefined } | undefined) =>
                fetch<Methods_1dirya6['put']['resBody']>(prefix, `${prefix2}${PATH6}`, PUT, option).json(),
              $put: (option?: { query?: Methods_1dirya6['put']['query'] | undefined, config?: T | undefined } | undefined) =>
                fetch<Methods_1dirya6['put']['resBody']>(prefix, `${prefix2}${PATH6}`, PUT, option).json().then(r => r.body),
              delete: (option: { query: Methods_1dirya6['delete']['query'], config?: T | undefined }) =>
                fetch<Methods_1dirya6['delete']['resBody']>(prefix, `${prefix2}${PATH6}`, DELETE, option).json(),
              $delete: (option: { query: Methods_1dirya6['delete']['query'], config?: T | undefined }) =>
                fetch<Methods_1dirya6['delete']['resBody']>(prefix, `${prefix2}${PATH6}`, DELETE, option).json().then(r => r.body),
      ...
      $3_1: {
        get: (option?: { query?: Methods_1f5sbkp['get']['query'] | undefined, headers?: Methods_1f5sbkp['get']['reqHeaders'] | undefined, config?: T | undefined } | undefined) =>
          fetch<Methods_1f5sbkp['get']['resBody']>(prefix, PATH8, GET, option).json(),
        $get: (option?: { query?: Methods_1f5sbkp['get']['query'] | undefined, headers?: Methods_1f5sbkp['get']['reqHeaders'] | undefined, config?: T | undefined } | undefined) =>
          fetch<Methods_1f5sbkp['get']['resBody']>(prefix, PATH8, GET, option).json().then(r => r.body),
        post: (option: { body?: Methods_1f5sbkp['post']['reqBody'] | undefined, query: Methods_1f5sbkp['post']['query'], config?: T | undefined }) =>
          fetch<Methods_1f5sbkp['post']['resBody']>(prefix, PATH8, POST, option, 'URLSearchParams').json(),
        $post: (option: { body?: Methods_1f5sbkp['post']['reqBody'] | undefined, query: Methods_1f5sbkp['post']['query'], config?: T | undefined }) =>
          fetch<Methods_1f5sbkp['post']['resBody']>(prefix, PATH8, POST, option, 'URLSearchParams').json().then(r => r.body),
      ...
      get: (option?: { query?: Methods_40e9ba['get']['query'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_40e9ba['get']['resBody'], BasicHeaders, Methods_40e9ba['get']['status']>(prefix, PATH3, GET, option).json(),
      $get: (option?: { query?: Methods_40e9ba['get']['query'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_40e9ba['get']['resBody'], BasicHeaders, Methods_40e9ba['get']['status']>(prefix, PATH3, GET, option).json().then(r => r.body),
    ...
    v2_0: {
      get: (option: { query: Methods_yyaags['get']['query'], headers: Methods_yyaags['get']['reqHeaders'], config?: T | undefined }) =>
        fetch<Methods_yyaags['get']['resBody'], Methods_yyaags['get']['resHeaders'], Methods_yyaags['get']['status']>(prefix, PATH10, GET, option).text(),
      $get: (option: { query: Methods_yyaags['get']['query'], headers: Methods_yyaags['get']['reqHeaders'], config?: T | undefined }) =>
        fetch<Methods_yyaags['get']['resBody'], Methods_yyaags['get']['resHeaders'], Methods_yyaags['get']['status']>(prefix, PATH10, GET, option).text().then(r => r.body),
