    ...
    _userId: (val0: string) => {
      ...
      return {
        get: (option: { query: Methods_14u5b7a['get']['query'], headers: Methods_14u5b7a['get']['reqHeaders'], config?: T | undefined }) =>
          fetch<Methods_14u5b7a['get']['resBody']>(prefix, `${prefix0}${PATH1}`, GET, option).json(),
        $get: (option: { query: Methods_14u5b7a['get']['query'], headers: Methods_14u5b7a['get']['reqHeaders'], config?: T | undefined }) =>
          fetch<Methods_14u5b7a['get']['resBody']>(prefix, `${prefix0}${PATH1}`, GET, option).json().then(r => r.body),
        post: (option: { query: Methods_14u5b7a['post']['query'], config?: T | undefined }) =>
          fetch<Methods_14u5b7a['post']['resBody']>(prefix, `${prefix0}${PATH1}`, POST, option).json(),
        $post: (option: { query: Methods_14u5b7a['post']['query'], config?: T | undefined }) =>
          fetch<Methods_14u5b7a['post']['resBody']>(prefix, `${prefix0}${PATH1}`, POST, option).json().then(r => r.body),
