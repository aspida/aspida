  ...
  return {
    $2: {
      _hogeId: (val1: number | string) => {
        ...
        return {
          get: (option?: { config?: T | undefined } | undefined) =>
            fetch<Methods_1863s82['get']['resBody']>(prefix, `${prefix1}${PATH2}`, GET, option).json(),
          $get: (option?: { config?: T | undefined } | undefined) =>
            fetch<Methods_1863s82['get']['resBody']>(prefix, `${prefix1}${PATH2}`, GET, option).json().then(r => r.body),
      ...
      _hogeId_number: (val1: number) => {
        ...
        return {
          get: (option: { query?: Methods_10jwsvn['get']['query'] | undefined, headers: Methods_10jwsvn['get']['reqHeaders'], config?: T | undefined }) =>
            fetch<Methods_10jwsvn['get']['resBody']>(prefix, `${prefix1}${PATH2}`, GET, option).json(),
          $get: (option: { query?: Methods_10jwsvn['get']['query'] | undefined, headers: Methods_10jwsvn['get']['reqHeaders'], config?: T | undefined }) =>
            fetch<Methods_10jwsvn['get']['resBody']>(prefix, `${prefix1}${PATH2}`, GET, option).json().then(r => r.body),
      ...
      _hogeId_string: (val1: string) => {
        ...
        return {
          entries_json: {
            get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_1c6yqcc['get']['resBody']>(prefix, `${prefix1}${PATH3}`, GET, option).json(),
            $get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_1c6yqcc['get']['resBody']>(prefix, `${prefix1}${PATH3}`, GET, option).json().then(r => r.body),
          ...
          test_4: {
            ...
            _fugaId: (val3: number | string) => {
              ...
              return {
                get: (option?: { query?: Methods_dqwexv['get']['query'] | undefined, config?: T | undefined } | undefined) =>
                  fetch<Methods_dqwexv['get']['resBody']>(prefix, `${prefix3}${PATH2}`, GET, option).json(),
                $get: (option?: { query?: Methods_dqwexv['get']['query'] | undefined, config?: T | undefined } | undefined) =>
                  fetch<Methods_dqwexv['get']['resBody']>(prefix, `${prefix3}${PATH2}`, GET, option).json().then(r => r.body),
                post: (option: { body?: Methods_dqwexv['post']['reqBody'] | undefined, query: Methods_dqwexv['post']['query'], config?: T | undefined }) =>
                  fetch<Methods_dqwexv['post']['resBody']>(prefix, `${prefix3}${PATH2}`, POST, option).json(),
                $post: (option: { body?: Methods_dqwexv['post']['reqBody'] | undefined, query: Methods_dqwexv['post']['query'], config?: T | undefined }) =>
                  fetch<Methods_dqwexv['post']['resBody']>(prefix, `${prefix3}${PATH2}`, POST, option).json().then(r => r.body),
                put: (option: { query: Methods_dqwexv['put']['query'], config?: T | undefined }) =>
                  fetch<Methods_dqwexv['put']['resBody']>(prefix, `${prefix3}${PATH2}`, PUT, option).json(),
                $put: (option: { query: Methods_dqwexv['put']['query'], config?: T | undefined }) =>
                  fetch<Methods_dqwexv['put']['resBody']>(prefix, `${prefix3}${PATH2}`, PUT, option).json().then(r => r.body),
                /**
                 * _fugaId delete method
                 * @returns _fugaId resBody
                 */
                delete: (option: { query: Methods_dqwexv['delete']['query'], config?: T | undefined }) =>
                  fetch<Methods_dqwexv['delete']['resBody']>(prefix, `${prefix3}${PATH2}`, DELETE, option).json(),
                /**
                 * _fugaId delete method
                 * @returns _fugaId resBody
                 */
                $delete: (option: { query: Methods_dqwexv['delete']['query'], config?: T | undefined }) =>
                  fetch<Methods_dqwexv['delete']['resBody']>(prefix, `${prefix3}${PATH2}`, DELETE, option).json().then(r => r.body),
            ...
            fuga_aa: {
              get: (option: { query: Methods_nqml4r['get']['query'], config?: T | undefined }) =>
                fetch<Methods_nqml4r['get']['resBody']>(prefix, `${prefix1}${PATH5}`, GET, option).json(),
              $get: (option: { query: Methods_nqml4r['get']['query'], config?: T | undefined }) =>
                fetch<Methods_nqml4r['get']['resBody']>(prefix, `${prefix1}${PATH5}`, GET, option).json().then(r => r.body),
              post: (option: { body?: Methods_nqml4r['post']['reqBody'] | undefined, query: Methods_nqml4r['post']['query'], config?: T | undefined }) =>
                fetch<Methods_nqml4r['post']['resBody']>(prefix, `${prefix1}${PATH5}`, POST, option).json(),
              $post: (option: { body?: Methods_nqml4r['post']['reqBody'] | undefined, query: Methods_nqml4r['post']['query'], config?: T | undefined }) =>
                fetch<Methods_nqml4r['post']['resBody']>(prefix, `${prefix1}${PATH5}`, POST, option).json().then(r => r.body),
              put: (option: { query: Methods_nqml4r['put']['query'], config?: T | undefined }) =>
                fetch<Methods_nqml4r['put']['resBody']>(prefix, `${prefix1}${PATH5}`, PUT, option).json(),
              $put: (option: { query: Methods_nqml4r['put']['query'], config?: T | undefined }) =>
                fetch<Methods_nqml4r['put']['resBody']>(prefix, `${prefix1}${PATH5}`, PUT, option).json().then(r => r.body),
              delete: (option: { body: Methods_nqml4r['delete']['reqBody'], query: Methods_nqml4r['delete']['query'], config?: T | undefined }) =>
                fetch<Methods_nqml4r['delete']['resBody']>(prefix, `${prefix1}${PATH5}`, DELETE, option).json(),
              $delete: (option: { body: Methods_nqml4r['delete']['reqBody'], query: Methods_nqml4r['delete']['query'], config?: T | undefined }) =>
                fetch<Methods_nqml4r['delete']['resBody']>(prefix, `${prefix1}${PATH5}`, DELETE, option).json().then(r => r.body),
            ...
            put: (option?: { query?: Methods_23mgxx['put']['query'] | undefined, config?: T | undefined } | undefined) =>
              fetch<Methods_23mgxx['put']['resBody']>(prefix, `${prefix1}${PATH4}`, PUT, option).json(),
            $put: (option?: { query?: Methods_23mgxx['put']['query'] | undefined, config?: T | undefined } | undefined) =>
              fetch<Methods_23mgxx['put']['resBody']>(prefix, `${prefix1}${PATH4}`, PUT, option).json().then(r => r.body),
            delete: (option: { query: Methods_23mgxx['delete']['query'], config?: T | undefined }) =>
              fetch<Methods_23mgxx['delete']['resBody']>(prefix, `${prefix1}${PATH4}`, DELETE, option).json(),
            $delete: (option: { query: Methods_23mgxx['delete']['query'], config?: T | undefined }) =>
              fetch<Methods_23mgxx['delete']['resBody']>(prefix, `${prefix1}${PATH4}`, DELETE, option).json().then(r => r.body),
    ...
    $3_1: {
      ...
      get: (option?: { query?: Methods_1xy14kq['get']['query'] | undefined, headers?: Methods_1xy14kq['get']['reqHeaders'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_1xy14kq['get']['resBody']>(prefix, PATH6, GET, option).json(),
      /**
       * 3.1 get method comment
       * @param option.headers - 3.1 reqHeaders
       */
      $get: (option?: { query?: Methods_1xy14kq['get']['query'] | undefined, headers?: Methods_1xy14kq['get']['reqHeaders'] | undefined, config?: T | undefined } | undefined) =>
        fetch<Methods_1xy14kq['get']['resBody']>(prefix, PATH6, GET, option).json().then(r => r.body),
      post: (option: { body?: Methods_1xy14kq['post']['reqBody'] | undefined, query: Methods_1xy14kq['post']['query'], config?: T | undefined }) =>
        fetch<Methods_1xy14kq['post']['resBody']>(prefix, PATH6, POST, option, 'URLSearchParams').json(),
      $post: (option: { body?: Methods_1xy14kq['post']['reqBody'] | undefined, query: Methods_1xy14kq['post']['query'], config?: T | undefined }) =>
        fetch<Methods_1xy14kq['post']['resBody']>(prefix, PATH6, POST, option, 'URLSearchParams').json().then(r => r.body),
    ...
    _articleId_json: (val0: number | string) => {
      ...
      return {
        get: (option?: { config?: T | undefined } | undefined) =>
          fetch<Methods_1j2b452['get']['resBody']>(prefix, `${prefix0}${PATH2}`, GET, option).json(),
        $get: (option?: { config?: T | undefined } | undefined) =>
          fetch<Methods_1j2b452['get']['resBody']>(prefix, `${prefix0}${PATH2}`, GET, option).json().then(r => r.body),
      ...
      _userId: (val1: string) => {
        ...
        return {
          get: (option: { query: Methods_pxqx5v['get']['query'], headers: Methods_pxqx5v['get']['reqHeaders'], config?: T | undefined }) =>
            fetch<Methods_pxqx5v['get']['resBody']>(prefix, `${prefix1}${PATH2}`, GET, option).json(),
          $get: (option: { query: Methods_pxqx5v['get']['query'], headers: Methods_pxqx5v['get']['reqHeaders'], config?: T | undefined }) =>
            fetch<Methods_pxqx5v['get']['resBody']>(prefix, `${prefix1}${PATH2}`, GET, option).json().then(r => r.body),
          post: (option: { query: Methods_pxqx5v['post']['query'], config?: T | undefined }) =>
            fetch<Methods_pxqx5v['post']['resBody']>(prefix, `${prefix1}${PATH2}`, POST, option).json(),
          $post: (option: { query: Methods_pxqx5v['post']['query'], config?: T | undefined }) =>
            fetch<Methods_pxqx5v['post']['resBody']>(prefix, `${prefix1}${PATH2}`, POST, option).json().then(r => r.body),
