  ...
  return {
    _hogeId: (val0: number | string) => {
      ...
      return {
        $get: (option?: { config?: T | undefined } | undefined) =>
          fetch<Methods_11hoj1j['get']['resBody']>(prefix, prefix0, GET, option).json().then(r => r.body),
        $path: () => `${prefix}${prefix0}`,
      };
    },
    _hogeId_number: (val0: number) => {
      ...
      return {
        $get: (option: { query?: Methods_16mvnls['get']['query'] | undefined, headers: Methods_16mvnls['get']['reqHeaders'], config?: T | undefined }) =>
          fetch<Methods_16mvnls['get']['resBody']>(prefix, prefix0, GET, option).json().then(r => r.body),
    ...
    _hogeId_string: (val0: string) => {
      ...
      return {
        entries_json: {
          $get: (option?: { config?: T | undefined } | undefined) =>
            fetch<Methods_59zc5['get']['resBody']>(prefix, `${prefix0}${PATH1}`, GET, option).json().then(r => r.body),
        ...
        test_4: {
          ...
          _fugaId: (val2: number | string) => {
            ...
            return {
              $get: (option?: { query?: Methods_1607xnu['get']['query'] | undefined, config?: T | undefined } | undefined) =>
                fetch<Methods_1607xnu['get']['resBody']>(prefix, prefix2, GET, option).json().then(r => r.body),
              $post: (option: { body?: Methods_1607xnu['post']['reqBody'] | undefined, query: Methods_1607xnu['post']['query'], config?: T | undefined }) =>
                fetch<Methods_1607xnu['post']['resBody']>(prefix, prefix2, POST, option).json().then(r => r.body),
              $put: (option: { query: Methods_1607xnu['put']['query'], config?: T | undefined }) =>
                fetch<Methods_1607xnu['put']['resBody']>(prefix, prefix2, PUT, option).json().then(r => r.body),
              /**
               * _fugaId delete method
               * @returns _fugaId resBody
               */
              $delete: (option: { query: Methods_1607xnu['delete']['query'], config?: T | undefined }) =>
                fetch<Methods_1607xnu['delete']['resBody']>(prefix, prefix2, DELETE, option).json().then(r => r.body),
          ...
          fuga_aa: {
            $get: (option: { query: Methods_12nwoh6['get']['query'], config?: T | undefined }) =>
              fetch<Methods_12nwoh6['get']['resBody']>(prefix, `${prefix0}${PATH3}`, GET, option).json().then(r => r.body),
            $post: (option: { body?: Methods_12nwoh6['post']['reqBody'] | undefined, query: Methods_12nwoh6['post']['query'], config?: T | undefined }) =>
              fetch<Methods_12nwoh6['post']['resBody']>(prefix, `${prefix0}${PATH3}`, POST, option).json().then(r => r.body),
            $put: (option: { query: Methods_12nwoh6['put']['query'], config?: T | undefined }) =>
              fetch<Methods_12nwoh6['put']['resBody']>(prefix, `${prefix0}${PATH3}`, PUT, option).json().then(r => r.body),
            $delete: (option: { body: Methods_12nwoh6['delete']['reqBody'], query: Methods_12nwoh6['delete']['query'], config?: T | undefined }) =>
              fetch<Methods_12nwoh6['delete']['resBody']>(prefix, `${prefix0}${PATH3}`, DELETE, option).json().then(r => r.body),
          ...
          $put: (option?: { query?: Methods_1gu1xec['put']['query'] | undefined, config?: T | undefined } | undefined) =>
            fetch<Methods_1gu1xec['put']['resBody']>(prefix, `${prefix0}${PATH2}`, PUT, option).json().then(r => r.body),
          $delete: (option: { query: Methods_1gu1xec['delete']['query'], config?: T | undefined }) =>
            fetch<Methods_1gu1xec['delete']['resBody']>(prefix, `${prefix0}${PATH2}`, DELETE, option).json().then(r => r.body),
