  ...
  return {
    ...
    _hogeId_string: (val2: string) => {
      ...
      return {
        entries_json: {
          get: (option?: { config?: T }) =>
            fetch<Methods2['get']['resBody']>(prefix, `${prefix2}${PATH2}`, GET, option).json(),
          $get: (option?: { config?: T }) =>
            fetch<Methods2['get']['resBody']>(prefix, `${prefix2}${PATH2}`, GET, option).json().then(r => r.body),
        ...
        test_4: {
          ...
          _fugaId: (val3: number | string) => {
            const prefix3 = `${prefix2}${PATH3}${val3}`

            return {
              get: (option?: { query?: Methods4['get']['query'], config?: T }) =>
                fetch<Methods4['get']['resBody']>(prefix, `${prefix3}${PATH1}`, GET, option).json(),
              $get: (option?: { query?: Methods4['get']['query'], config?: T }) =>
                fetch<Methods4['get']['resBody']>(prefix, `${prefix3}${PATH1}`, GET, option).json().then(r => r.body),
              post: (option: { body?: Methods4['post']['reqBody'], query: Methods4['post']['query'], config?: T }) =>
                fetch<Methods4['post']['resBody']>(prefix, `${prefix3}${PATH1}`, POST, option).json(),
              $post: (option: { body?: Methods4['post']['reqBody'], query: Methods4['post']['query'], config?: T }) =>
                fetch<Methods4['post']['resBody']>(prefix, `${prefix3}${PATH1}`, POST, option).json().then(r => r.body),
              put: (option: { query: Methods4['put']['query'], config?: T }) =>
                fetch<Methods4['put']['resBody']>(prefix, `${prefix3}${PATH1}`, PUT, option).json(),
              $put: (option: { query: Methods4['put']['query'], config?: T }) =>
                fetch<Methods4['put']['resBody']>(prefix, `${prefix3}${PATH1}`, PUT, option).json().then(r => r.body),
              /**
               * _fugaId delete method
               * @returns _fugaId resBody
               */
              delete: (option: { query: Methods4['delete']['query'], config?: T }) =>
                fetch<Methods4['delete']['resBody']>(prefix, `${prefix3}${PATH1}`, DELETE, option).json(),
              /**
               * _fugaId delete method
               * @returns _fugaId resBody
               */
              $delete: (option: { query: Methods4['delete']['query'], config?: T }) =>
                fetch<Methods4['delete']['resBody']>(prefix, `${prefix3}${PATH1}`, DELETE, option).json().then(r => r.body),
          ...
          fuga_aa: {
            ...
            post: (option: { body?: Methods5['post']['reqBody'], query: Methods5['post']['query'], config?: T }) =>
              fetch<Methods5['post']['resBody']>(prefix, `${prefix2}${PATH4}`, POST, option).json(),
            $post: (option: { body?: Methods5['post']['reqBody'], query: Methods5['post']['query'], config?: T }) =>
              fetch<Methods5['post']['resBody']>(prefix, `${prefix2}${PATH4}`, POST, option).json().then(r => r.body),
            put: (option: { query: Methods5['put']['query'], config?: T }) =>
              fetch<Methods5['put']['resBody']>(prefix, `${prefix2}${PATH4}`, PUT, option).json(),
            $put: (option: { query: Methods5['put']['query'], config?: T }) =>
              fetch<Methods5['put']['resBody']>(prefix, `${prefix2}${PATH4}`, PUT, option).json().then(r => r.body),
            delete: (option: { body: Methods5['delete']['reqBody'], query: Methods5['delete']['query'], config?: T }) =>
              fetch<Methods5['delete']['resBody']>(prefix, `${prefix2}${PATH4}`, DELETE, option).json(),
            $delete: (option: { body: Methods5['delete']['reqBody'], query: Methods5['delete']['query'], config?: T }) =>
              fetch<Methods5['delete']['resBody']>(prefix, `${prefix2}${PATH4}`, DELETE, option).json().then(r => r.body),
          ...
          get: (option: { query: Methods3['get']['query'], config?: T }) =>
            fetch(prefix, `${prefix2}${PATH3}`, GET, option).send(),
          $get: (option: { query: Methods3['get']['query'], config?: T }) =>
            fetch(prefix, `${prefix2}${PATH3}`, GET, option).send().then(r => r.body),
          ...
          put: (option?: { query?: Methods3['put']['query'], config?: T }) =>
            fetch<Methods3['put']['resBody']>(prefix, `${prefix2}${PATH3}`, PUT, option).json(),
          $put: (option?: { query?: Methods3['put']['query'], config?: T }) =>
            fetch<Methods3['put']['resBody']>(prefix, `${prefix2}${PATH3}`, PUT, option).json().then(r => r.body),
          delete: (option: { query: Methods3['delete']['query'], config?: T }) =>
            fetch<Methods3['delete']['resBody']>(prefix, `${prefix2}${PATH3}`, DELETE, option).json(),
          $delete: (option: { query: Methods3['delete']['query'], config?: T }) =>
            fetch<Methods3['delete']['resBody']>(prefix, `${prefix2}${PATH3}`, DELETE, option).json().then(r => r.body),
