...
const api = <T>({ baseURL, fetch }: AspidaClient<T>) => {
  ...
  return {
    _sampleId_json: (val0: number) => {
      ...
      return {
        get: (option?: { config?: T }) =>
          fetch<Methods1['get']['resBody']>(prefix0, PATH0, GET, option).json(),
        $get: (option?: { config?: T }) =>
          fetch<Methods1['get']['resBody']>(prefix0, PATH0, GET, option).json().then(r => r.body)
      }
    },
    v1_1: {
      $2: {
        _hogeId_0: (val1: ApiTypes.HogeId) => {
          ...
          return {
            entries_json: {
              get: (option?: { config?: T }) =>
                fetch<Methods3['get']['resBody']>(prefix1, PATH2, GET, option).json(),
              $get: (option?: { config?: T }) =>
                fetch<Methods3['get']['resBody']>(prefix1, PATH2, GET, option).json().then(r => r.body)
            },
            test_4: {
              _fugaId: (val2: number | string) => {
                ...
                return {
                  ...
                  post: (option: { body?: Methods5['post']['reqBody'], query: Methods5['post']['query'], config?: T }) =>
                    fetch<Methods5['post']['resBody']>(prefix2, PATH0, POST, option).json(),
                  $post: (option: { body?: Methods5['post']['reqBody'], query: Methods5['post']['query'], config?: T }) =>
                    fetch<Methods5['post']['resBody']>(prefix2, PATH0, POST, option).json().then(r => r.body),
                  put: (option: { query: Methods5['put']['query'], config?: T }) =>
                    fetch<Methods5['put']['resBody']>(prefix2, PATH0, PUT, option).json(),
                  $put: (option: { query: Methods5['put']['query'], config?: T }) =>
                    fetch<Methods5['put']['resBody']>(prefix2, PATH0, PUT, option).json().then(r => r.body),
                  delete: (option: { query: Methods5['delete']['query'], config?: T }) =>
                    fetch<Methods5['delete']['resBody']>(prefix2, PATH0, DELETE, option).json(),
                  $delete: (option: { query: Methods5['delete']['query'], config?: T }) =>
                    fetch<Methods5['delete']['resBody']>(prefix2, PATH0, DELETE, option).json().then(r => r.body)
                }
              },
              fuga_aa: {
                get: (option: { query: Methods6['get']['query'], config?: T }) =>
                  fetch<Methods6['get']['resBody']>(prefix1, PATH4, GET, option).json(),
                $get: (option: { query: Methods6['get']['query'], config?: T }) =>
                  fetch<Methods6['get']['resBody']>(prefix1, PATH4, GET, option).json().then(r => r.body),
                post: (option: { body?: Methods6['post']['reqBody'], query: Methods6['post']['query'], config?: T }) =>
                  fetch<Methods6['post']['resBody']>(prefix1, PATH4, POST, option).json(),
                $post: (option: { body?: Methods6['post']['reqBody'], query: Methods6['post']['query'], config?: T }) =>
                  fetch<Methods6['post']['resBody']>(prefix1, PATH4, POST, option).json().then(r => r.body),
                put: (option: { query: Methods6['put']['query'], config?: T }) =>
                  fetch<Methods6['put']['resBody']>(prefix1, PATH4, PUT, option).json(),
                $put: (option: { query: Methods6['put']['query'], config?: T }) =>
                  fetch<Methods6['put']['resBody']>(prefix1, PATH4, PUT, option).json().then(r => r.body),
                delete: (option: { body: Methods6['delete']['reqBody'], query: Methods6['delete']['query'], config?: T }) =>
                  fetch<Methods6['delete']['resBody']>(prefix1, PATH4, DELETE, option).json(),
                $delete: (option: { body: Methods6['delete']['reqBody'], query: Methods6['delete']['query'], config?: T }) =>
                  fetch<Methods6['delete']['resBody']>(prefix1, PATH4, DELETE, option).json().then(r => r.body)
              },
              get: (option: { query: Methods4['get']['query'], config?: T }) =>
                fetch<void>(prefix1, PATH3, GET, option).send(),
              $get: (option: { query: Methods4['get']['query'], config?: T }) =>
                fetch<void>(prefix1, PATH3, GET, option).send().then(r => r.body),
              post: (option?: { body?: Methods4['post']['reqBody'], query?: Methods4['post']['query'], config?: T }) =>
                fetch<void>(prefix1, PATH3, POST, option).send(),
              $post: (option?: { body?: Methods4['post']['reqBody'], query?: Methods4['post']['query'], config?: T }) =>
                fetch<void>(prefix1, PATH3, POST, option).send().then(r => r.body),
              put: (option?: { query?: Methods4['put']['query'], config?: T }) =>
                fetch<Methods4['put']['resBody']>(prefix1, PATH3, PUT, option).json(),
              $put: (option?: { query?: Methods4['put']['query'], config?: T }) =>
                fetch<Methods4['put']['resBody']>(prefix1, PATH3, PUT, option).json().then(r => r.body),
              delete: (option: { query: Methods4['delete']['query'], config?: T }) =>
                fetch<Methods4['delete']['resBody']>(prefix1, PATH3, DELETE, option).json(),
              $delete: (option: { query: Methods4['delete']['query'], config?: T }) =>
                fetch<Methods4['delete']['resBody']>(prefix1, PATH3, DELETE, option).json().then(r => r.body)
            }
          }
        },
      ...
      _articleId_json: (val4: number | string) => {
        ...
        return {
          get: (option?: { config?: T }) =>
            fetch<Methods9['get']['resBody']>(prefix4, PATH0, GET, option).json(),
          $get: (option?: { config?: T }) =>
            fetch<Methods9['get']['resBody']>(prefix4, PATH0, GET, option).json().then(r => r.body)
        }
      },
      users: {
        _userId: (val5: ApiTypes.User['id']) => {
          ...
          return {
            get: (option: { query: Methods10['get']['query'], headers: Methods10['get']['reqHeaders'], config?: T }) =>
              fetch<Methods10['get']['resBody']>(prefix5, PATH0, GET, option).json(),
            $get: (option: { query: Methods10['get']['query'], headers: Methods10['get']['reqHeaders'], config?: T }) =>
              fetch<Methods10['get']['resBody']>(prefix5, PATH0, GET, option).json().then(r => r.body),
            post: (option: { query: Methods10['post']['query'], config?: T }) =>
              fetch<Methods10['post']['resBody']>(prefix5, PATH0, POST, option).json(),
            $post: (option: { query: Methods10['post']['query'], config?: T }) =>
              fetch<Methods10['post']['resBody']>(prefix5, PATH0, POST, option).json().then(r => r.body)
          }
        }
      },
    ...
    v2_0: {
      get: (option: { query: Methods11['get']['query'], headers: Methods11['get']['reqHeaders'], config?: T }) =>
        fetch<Methods11['get']['resBody'], Methods11['get']['resHeaders'], Methods11['get']['status']>(prefix, PATH6, GET, option).text(),
      $get: (option: { query: Methods11['get']['query'], headers: Methods11['get']['reqHeaders'], config?: T }) =>
        fetch<Methods11['get']['resBody'], Methods11['get']['resHeaders'], Methods11['get']['status']>(prefix, PATH6, GET, option).text().then(r => r.body)
    },
