    ...
    v1_1: {
      $2: {
        _hogeId_0: (val1: ApiTypes.HogeId) => {
          const prefix1 = `${prefix}${PATH2}${val1}`

          return {
            entries_json: {
              get: (option?: { config?: T }) =>
                fetch<Methods3['get']['resBody']>(prefix1, PATH3, GET, option).json(),
              $get: (option?: { config?: T }) =>
                fetch<Methods3['get']['resBody']>(prefix1, PATH3, GET, option).json().then(r => r.body)
            },
            test_4: {
              ...
              fuga_aa: {
                get: (option: { query: Methods6['get']['query'], config?: T }) =>
                  fetch<Methods6['get']['resBody']>(prefix1, PATH5, GET, option).json(),
                $get: (option: { query: Methods6['get']['query'], config?: T }) =>
                  fetch<Methods6['get']['resBody']>(prefix1, PATH5, GET, option).json().then(r => r.body),
                post: (option: { body?: Methods6['post']['reqBody'], query: Methods6['post']['query'], config?: T }) =>
                  fetch<Methods6['post']['resBody']>(prefix1, PATH5, POST, option).json(),
                $post: (option: { body?: Methods6['post']['reqBody'], query: Methods6['post']['query'], config?: T }) =>
                  fetch<Methods6['post']['resBody']>(prefix1, PATH5, POST, option).json().then(r => r.body),
                put: (option: { query: Methods6['put']['query'], config?: T }) =>
                  fetch<Methods6['put']['resBody']>(prefix1, PATH5, PUT, option).json(),
                $put: (option: { query: Methods6['put']['query'], config?: T }) =>
                  fetch<Methods6['put']['resBody']>(prefix1, PATH5, PUT, option).json().then(r => r.body),
                delete: (option: { body: Methods6['delete']['reqBody'], query: Methods6['delete']['query'], config?: T }) =>
                  fetch<Methods6['delete']['resBody']>(prefix1, PATH5, DELETE, option).json(),
                $delete: (option: { body: Methods6['delete']['reqBody'], query: Methods6['delete']['query'], config?: T }) =>
                  fetch<Methods6['delete']['resBody']>(prefix1, PATH5, DELETE, option).json().then(r => r.body)
              },
              get: (option: { query: Methods4['get']['query'], config?: T }) =>
                fetch<void>(prefix1, PATH4, GET, option).send(),
              $get: (option: { query: Methods4['get']['query'], config?: T }) =>
                fetch<void>(prefix1, PATH4, GET, option).send().then(r => r.body),
              post: (option?: { body?: Methods4['post']['reqBody'], query?: Methods4['post']['query'], config?: T }) =>
                fetch<void>(prefix1, PATH4, POST, option).send(),
              $post: (option?: { body?: Methods4['post']['reqBody'], query?: Methods4['post']['query'], config?: T }) =>
                fetch<void>(prefix1, PATH4, POST, option).send().then(r => r.body),
              put: (option?: { query?: Methods4['put']['query'], config?: T }) =>
                fetch<Methods4['put']['resBody']>(prefix1, PATH4, PUT, option).json(),
              $put: (option?: { query?: Methods4['put']['query'], config?: T }) =>
                fetch<Methods4['put']['resBody']>(prefix1, PATH4, PUT, option).json().then(r => r.body),
              delete: (option: { query: Methods4['delete']['query'], config?: T }) =>
                fetch<Methods4['delete']['resBody']>(prefix1, PATH4, DELETE, option).json(),
              $delete: (option: { query: Methods4['delete']['query'], config?: T }) =>
                fetch<Methods4['delete']['resBody']>(prefix1, PATH4, DELETE, option).json().then(r => r.body)
            }
          }
        },
        _hogeId_1: (val3: number) => {
          const prefix3 = `${prefix}${PATH2}${val3}`
      ...
      _articleId_json: (val4: number | string) => {
        const prefix4 = `${prefix}${PATH1}${val4}.json`
      ...
      users: {
        _userId: (val5: ApiTypes.User['id']) => {
          const prefix5 = `${prefix}${PATH7}${val5}`
