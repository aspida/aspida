  ...
  return {
    ...
    v1_1: {
      $2: {
        ...
        _hogeId_string: (val4: string) => {
          ...
          return {
            entries_json: {
              get: (option?: { config?: T }) =>
                fetch<Methods7['get']['resBody']>(prefix, `${prefix4}${PATH3}`, GET, option).json(),
              $get: (option?: { config?: T }) =>
                fetch<Methods7['get']['resBody']>(prefix, `${prefix4}${PATH3}`, GET, option).json().then(r => r.body),
              $path: () => `${prefix}${prefix4}${PATH3}`
            },
            test_4: {
              _fugaId: (val5: number | string) => {
                const prefix5 = `${prefix4}${PATH4}/${val5}`

                return {
                  get: (option?: { query?: Methods9['get']['query'], config?: T }) =>
                    fetch<Methods9['get']['resBody']>(prefix, prefix5, GET, option).json(),
                  $get: (option?: { query?: Methods9['get']['query'], config?: T }) =>
                    fetch<Methods9['get']['resBody']>(prefix, prefix5, GET, option).json().then(r => r.body),
                  post: (option: { body?: Methods9['post']['reqBody'], query: Methods9['post']['query'], config?: T }) =>
                    fetch<Methods9['post']['resBody']>(prefix, prefix5, POST, option).json(),
                  $post: (option: { body?: Methods9['post']['reqBody'], query: Methods9['post']['query'], config?: T }) =>
                    fetch<Methods9['post']['resBody']>(prefix, prefix5, POST, option).json().then(r => r.body),
                  put: (option: { query: Methods9['put']['query'], config?: T }) =>
                    fetch<Methods9['put']['resBody']>(prefix, prefix5, PUT, option).json(),
                  $put: (option: { query: Methods9['put']['query'], config?: T }) =>
                    fetch<Methods9['put']['resBody']>(prefix, prefix5, PUT, option).json().then(r => r.body),
                  delete: (option: { query: Methods9['delete']['query'], config?: T }) =>
                    fetch<Methods9['delete']['resBody']>(prefix, prefix5, DELETE, option).json(),
                  $delete: (option: { query: Methods9['delete']['query'], config?: T }) =>
                    fetch<Methods9['delete']['resBody']>(prefix, prefix5, DELETE, option).json().then(r => r.body),
              ...
              fuga_aa: {
                get: (option: { query: Methods10['get']['query'], config?: T }) =>
                  fetch<Methods10['get']['resBody']>(prefix, `${prefix4}${PATH5}`, GET, option).json(),
                $get: (option: { query: Methods10['get']['query'], config?: T }) =>
                  fetch<Methods10['get']['resBody']>(prefix, `${prefix4}${PATH5}`, GET, option).json().then(r => r.body),
                post: (option: { body?: Methods10['post']['reqBody'], query: Methods10['post']['query'], config?: T }) =>
                  fetch<Methods10['post']['resBody']>(prefix, `${prefix4}${PATH5}`, POST, option).json(),
                $post: (option: { body?: Methods10['post']['reqBody'], query: Methods10['post']['query'], config?: T }) =>
                  fetch<Methods10['post']['resBody']>(prefix, `${prefix4}${PATH5}`, POST, option).json().then(r => r.body),
                put: (option: { query: Methods10['put']['query'], config?: T }) =>
                  fetch<Methods10['put']['resBody']>(prefix, `${prefix4}${PATH5}`, PUT, option).json(),
                $put: (option: { query: Methods10['put']['query'], config?: T }) =>
                  fetch<Methods10['put']['resBody']>(prefix, `${prefix4}${PATH5}`, PUT, option).json().then(r => r.body),
                delete: (option: { body: Methods10['delete']['reqBody'], query: Methods10['delete']['query'], config?: T }) =>
                  fetch<Methods10['delete']['resBody']>(prefix, `${prefix4}${PATH5}`, DELETE, option).json(),
                $delete: (option: { body: Methods10['delete']['reqBody'], query: Methods10['delete']['query'], config?: T }) =>
                  fetch<Methods10['delete']['resBody']>(prefix, `${prefix4}${PATH5}`, DELETE, option).json().then(r => r.body),
              ...
              get: (option: { query: Methods8['get']['query'], config?: T }) =>
                fetch(prefix, `${prefix4}${PATH4}`, GET, option).send(),
              $get: (option: { query: Methods8['get']['query'], config?: T }) =>
                fetch(prefix, `${prefix4}${PATH4}`, GET, option).send().then(r => r.body),
              post: (option?: { body?: Methods8['post']['reqBody'], query?: Methods8['post']['query'], config?: T }) =>
                fetch(prefix, `${prefix4}${PATH4}`, POST, option).send(),
              $post: (option?: { body?: Methods8['post']['reqBody'], query?: Methods8['post']['query'], config?: T }) =>
                fetch(prefix, `${prefix4}${PATH4}`, POST, option).send().then(r => r.body),
              put: (option?: { query?: Methods8['put']['query'], config?: T }) =>
                fetch<Methods8['put']['resBody']>(prefix, `${prefix4}${PATH4}`, PUT, option).json(),
              $put: (option?: { query?: Methods8['put']['query'], config?: T }) =>
                fetch<Methods8['put']['resBody']>(prefix, `${prefix4}${PATH4}`, PUT, option).json().then(r => r.body),
              delete: (option: { query: Methods8['delete']['query'], config?: T }) =>
                fetch<Methods8['delete']['resBody']>(prefix, `${prefix4}${PATH4}`, DELETE, option).json(),
              $delete: (option: { query: Methods8['delete']['query'], config?: T }) =>
                fetch<Methods8['delete']['resBody']>(prefix, `${prefix4}${PATH4}`, DELETE, option).json().then(r => r.body),
              $path: (option?: { method?: 'get'; query: Methods8['get']['query'] } | { method: 'post'; query: Methods8['post']['query'] } | { method: 'put'; query: Methods8['put']['query'] } | { method: 'delete'; query: Methods8['delete']['query'] }) =>
                `${prefix}${prefix4}${PATH4}${option && option.query ? `?${dataToURLString(option.query)}` : ''}`
            }
          }
        }
      },
      $3_1: {
        get: (option?: { query?: Methods11['get']['query'], headers?: Methods11['get']['reqHeaders'], config?: T }) =>
          fetch<Methods11['get']['resBody']>(prefix, PATH6, GET, option).json(),
        $get: (option?: { query?: Methods11['get']['query'], headers?: Methods11['get']['reqHeaders'], config?: T }) =>
          fetch<Methods11['get']['resBody']>(prefix, PATH6, GET, option).json().then(r => r.body),
        post: (option: { body?: Methods11['post']['reqBody'], query: Methods11['post']['query'], config?: T }) =>
          fetch<Methods11['post']['resBody']>(prefix, PATH6, POST, option, 'URLSearchParams').json(),
        $post: (option: { body?: Methods11['post']['reqBody'], query: Methods11['post']['query'], config?: T }) =>
          fetch<Methods11['post']['resBody']>(prefix, PATH6, POST, option, 'URLSearchParams').json().then(r => r.body),
        ...
        _userId: (val7: string) => {
          ...
          return {
            get: (option: { query: Methods13['get']['query'], headers: Methods13['get']['reqHeaders'], config?: T }) =>
              fetch<Methods13['get']['resBody']>(prefix, prefix7, GET, option).json(),
            $get: (option: { query: Methods13['get']['query'], headers: Methods13['get']['reqHeaders'], config?: T }) =>
              fetch<Methods13['get']['resBody']>(prefix, prefix7, GET, option).json().then(r => r.body),
            post: (option: { query: Methods13['post']['query'], config?: T }) =>
              fetch<Methods13['post']['resBody']>(prefix, prefix7, POST, option).json(),
            $post: (option: { query: Methods13['post']['query'], config?: T }) =>
              fetch<Methods13['post']['resBody']>(prefix, prefix7, POST, option).json().then(r => r.body),
    ...
    v2_0: {
      get: (option: { query: Methods14['get']['query'], headers: Methods14['get']['reqHeaders'], config?: T }) =>
        fetch<Methods14['get']['resBody'], Methods14['get']['resHeaders'], Methods14['get']['status']>(prefix, PATH8, GET, option).text(),
      $get: (option: { query: Methods14['get']['query'], headers: Methods14['get']['reqHeaders'], config?: T }) =>
        fetch<Methods14['get']['resBody'], Methods14['get']['resHeaders'], Methods14['get']['status']>(prefix, PATH8, GET, option).text().then(r => r.body),
