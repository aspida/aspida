      ...
      $2: {
        ...
        _hogeId_number: (val2: number) => {
          ...
          return {
            $get: (option: { query?: Methods7['get']['query'], headers: Methods7['get']['reqHeaders'], config?: RequestInit }) =>
              send<Methods7['get']['resBody']>(f, GET, prefix, `${prefix2}${PATH0}`, 'json', option),
        ...
        _hogeId_string: (val2: string) => {
          ...
          return {
            entries_json: {
              $get: (option?: { config?: RequestInit }) =>
                send<Methods8['get']['resBody']>(f, GET, prefix, `${prefix2}${PATH4}`, 'json', option),
            ...
            test_4: {
              ...
              _fugaId: (val4: number | string) => {
                ...
                return {
                  $get: (option?: { query?: Methods10['get']['query'], config?: RequestInit }) =>
                    send<Methods10['get']['resBody']>(f, GET, prefix, `${prefix4}${PATH0}`, 'json', option),
                  $post: (option: { body?: Methods10['post']['reqBody'], query: Methods10['post']['query'], config?: RequestInit }) =>
                    send<Methods10['post']['resBody']>(f, POST, prefix, `${prefix4}${PATH0}`, 'json', option),
                  $put: (option: { query: Methods10['put']['query'], config?: RequestInit }) =>
                    send<Methods10['put']['resBody']>(f, PUT, prefix, `${prefix4}${PATH0}`, 'json', option),
                  /**
                   * _fugaId delete method
                   * @returns _fugaId resBody
                   */
                  $delete: (option: { query: Methods10['delete']['query'], config?: RequestInit }) =>
                    send<Methods10['delete']['resBody']>(f, DELETE, prefix, `${prefix4}${PATH0}`, 'json', option),
              ...
              fuga_aa: {
                $get: (option: { query: Methods11['get']['query'], config?: RequestInit }) =>
                  send<Methods11['get']['resBody']>(f, GET, prefix, `${prefix2}${PATH6}`, 'json', option),
                $post: (option: { body?: Methods11['post']['reqBody'], query: Methods11['post']['query'], config?: RequestInit }) =>
                  send<Methods11['post']['resBody']>(f, POST, prefix, `${prefix2}${PATH6}`, 'json', option),
                $put: (option: { query: Methods11['put']['query'], config?: RequestInit }) =>
                  send<Methods11['put']['resBody']>(f, PUT, prefix, `${prefix2}${PATH6}`, 'json', option),
                $delete: (option: { body: Methods11['delete']['reqBody'], query: Methods11['delete']['query'], config?: RequestInit }) =>
                  send<Methods11['delete']['resBody']>(f, DELETE, prefix, `${prefix2}${PATH6}`, 'json', option),
              ...
              $put: (option?: { query?: Methods9['put']['query'], config?: RequestInit }) =>
                send<Methods9['put']['resBody']>(f, PUT, prefix, `${prefix2}${PATH5}`, 'json', option),
              $delete: (option: { query: Methods9['delete']['query'], config?: RequestInit }) =>
                send<Methods9['delete']['resBody']>(f, DELETE, prefix, `${prefix2}${PATH5}`, 'json', option),
