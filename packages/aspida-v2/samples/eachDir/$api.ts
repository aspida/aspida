  ...
  return {
    _sampleId_json: (val0: number) => {
      ...
      return {
        $get: (option?: { init?: RequestInit }) =>
          send<Methods1['get']['res']>(GET, prefix, `${prefix0}${PATH0}`, 'json', 'void', option),
    ...
    foo_bar: {
      _bar_id_json: (val1: string) => {
        ...
        return {
          $get: (option?: { init?: RequestInit }) =>
            send<Methods3['get']['res']>(GET, prefix, `${prefix1}${PATH0}`, 'text', 'void', option),
      ...
      _fooId_create: (val1: number) => {
        ...
        return {
          $get: (option?: { init?: RequestInit }) =>
            send<Methods4['get']['res']>(GET, prefix, `${prefix1}${PATH0}`, 'text', 'void', option),
          $path: () => `${prefix}${prefix1}${PATH0}`
        }
      },
      $get: (option?: { init?: RequestInit }) =>
        send<Methods2['get']['res']>(GET, prefix, PATH1, 'text', 'void', option),
      $path: () => `${prefix}${PATH1}`
    },
    v1_1: {
      $2: {
        _hogeId_number: (val2: number) => {
          ...
          return {
            $get: (option: Methods6['get']['req'] & { init?: RequestInit }) =>
              send<Methods6['get']['res']>(GET, prefix, `${prefix2}${PATH0}`, 'json', 'void', option),
        ...
        _hogeId_string: (val2: string) => {
          ...
          return {
            entries_json: {
              $get: (option?: { init?: RequestInit }) =>
                send<Methods7['get']['res']>(GET, prefix, `${prefix2}${PATH4}`, 'json', 'void', option),
            ...
            test_4: {
              ...
              _fugaId: (val4: number | string) => {
                ...
                return {
                  $get: (option?: Methods9['get']['req'] & { init?: RequestInit }) =>
                    send<Methods9['get']['res']>(GET, prefix, `${prefix4}${PATH0}`, 'json', 'void', option),
                  $post: (option: Methods9['post']['req'] & { init?: RequestInit }) =>
                    send<Methods9['post']['res']>(POST, prefix, `${prefix4}${PATH0}`, 'json', 'void', option),
                  $put: (option: Methods9['put']['req'] & { init?: RequestInit }) =>
                    send<Methods9['put']['res']>(PUT, prefix, `${prefix4}${PATH0}`, 'json', 'void', option),
                  /**
                   * _fugaId delete method
                   * @returns _fugaId resBody
                   */
                  $delete: (option: Methods9['delete']['req'] & { init?: RequestInit }) =>
                    send<Methods9['delete']['res']>(DELETE, prefix, `${prefix4}${PATH0}`, 'json', 'void', option),
              ...
              fuga_aa: {
                $get: (option: Methods10['get']['req'] & { init?: RequestInit }) =>
                  send<Methods10['get']['res']>(GET, prefix, `${prefix2}${PATH6}`, 'json', 'void', option),
                $post: (option: Methods10['post']['req'] & { init?: RequestInit }) =>
                  send<Methods10['post']['res']>(POST, prefix, `${prefix2}${PATH6}`, 'json', 'void', option),
                $put: (option: Methods10['put']['req'] & { init?: RequestInit }) =>
                  send<Methods10['put']['res']>(PUT, prefix, `${prefix2}${PATH6}`, 'json', 'void', option),
                $delete: (option: Methods10['delete']['req'] & { init?: RequestInit }) =>
                  send<Methods10['delete']['res']>(DELETE, prefix, `${prefix2}${PATH6}`, 'json', 'void', option),
              ...
              $get: (option: Methods8['get']['req'] & { init?: RequestInit }) =>
                send<{}>(GET, prefix, `${prefix2}${PATH5}`, 'void', 'void', option),
              $post: (option?: Methods8['post']['req'] & { init?: RequestInit }) =>
                send<{}>(POST, prefix, `${prefix2}${PATH5}`, 'void', 'void', option),
              $put: (option?: Methods8['put']['req'] & { init?: RequestInit }) =>
                send<Methods8['put']['res']>(PUT, prefix, `${prefix2}${PATH5}`, 'json', 'void', option),
              $delete: (option: Methods8['delete']['req'] & { init?: RequestInit }) =>
                send<Methods8['delete']['res']>(DELETE, prefix, `${prefix2}${PATH5}`, 'json', 'void', option),
        ...
        _hogeId: (val2: number | string) => {
          ...
          return {
            $get: (option?: { init?: RequestInit }) =>
              send<Methods11['get']['res']>(GET, prefix, `${prefix2}${PATH0}`, 'json', 'void', option),
      ...
      $3_1: {
        ...
        $get: (option?: Methods12['get']['req'] & { init?: RequestInit }) =>
          send<Methods12['get']['res']>(GET, prefix, PATH7, 'json', 'void', option),
        $post: (option: Omit<Methods12['post']['req'], 'format'> & { init?: RequestInit }) =>
          send<Methods12['post']['res']>(POST, prefix, PATH7, 'json', 'void', option, URLSEARCHPARAMS),
      ...
      _articleId_json: (val1: number | string) => {
        ...
        return {
          $get: (option?: { init?: RequestInit }) =>
            send<Methods13['get']['res']>(GET, prefix, `${prefix1}${PATH0}`, 'json', 'void', option),
          $path: () => `${prefix}${prefix1}${PATH0}`
        }
      },
      users: {
        _userId: (val2: string) => {
          ...
          return {
            $get: (option: Methods14['get']['req'] & { init?: RequestInit }) =>
              send<Methods14['get']['res']>(GET, prefix, `${prefix2}${PATH0}`, 'json', 'void', option),
            $post: (option: Methods14['post']['req'] & { init?: RequestInit }) =>
              send<Methods14['post']['res']>(POST, prefix, `${prefix2}${PATH0}`, 'json', 'void', option),
      ...
      $get: (option?: Methods5['get']['req'] & { init?: RequestInit }) =>
        send<Methods5['get']['res']>(GET, prefix, PATH2, 'json', 'void', option),
    ...
    v2_0: {
      $get: (option: Methods15['get']['req'] & { init?: RequestInit }) =>
        send<Methods15['get']['res']>(GET, prefix, PATH9, 'text', 'void', option),
    ...
    $get: (option?: Methods0['get']['req'] & { init?: RequestInit }) =>
      send<Methods0['get']['res']>(GET, prefix, PATH0, 'formData', 'void', option),
    /**
     * @param option.body - body comment
     */
    $post: (option: Methods0['post']['req'] & { init?: RequestInit }) =>
      send<Methods0['post']['res']>(POST, prefix, PATH0, 'arrayBuffer', 'void', option),
    /**
     * put method comment
    ...
    $put: (option: Methods0['put']['req'] & { init?: RequestInit }) =>
      send<Methods0['put']['res']>(PUT, prefix, PATH0, 'json', 'void', option),
    $delete: (option: Methods0['delete']['req'] & { init?: RequestInit }) =>
      send<Methods0['delete']['res']>(DELETE, prefix, PATH0, 'void', 'void', option),
