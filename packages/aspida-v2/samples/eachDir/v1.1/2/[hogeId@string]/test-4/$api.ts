  ...
  return {
    ...
    _fugaId: (val0: number | string) => {
      ...
      return {
        $get: (option?: Methods1['get']['req'] & { init?: RequestInit }) =>
          send<Methods1['get']['res']>(GET, prefix, `${prefix0}${PATH1}`, 'json', 'void', option),
        $post: (option: Methods1['post']['req'] & { init?: RequestInit }) =>
          send<Methods1['post']['res']>(POST, prefix, `${prefix0}${PATH1}`, 'json', 'void', option),
        $put: (option: Methods1['put']['req'] & { init?: RequestInit }) =>
          send<Methods1['put']['res']>(PUT, prefix, `${prefix0}${PATH1}`, 'json', 'void', option),
        /**
         * _fugaId delete method
         * @returns _fugaId resBody
         */
        $delete: (option: Methods1['delete']['req'] & { init?: RequestInit }) =>
          send<Methods1['delete']['res']>(DELETE, prefix, `${prefix0}${PATH1}`, 'json', 'void', option),
    ...
    fuga_aa: {
      $get: (option: Methods2['get']['req'] & { init?: RequestInit }) =>
        send<Methods2['get']['res']>(GET, prefix, PATH2, 'json', 'void', option),
      $post: (option: Methods2['post']['req'] & { init?: RequestInit }) =>
        send<Methods2['post']['res']>(POST, prefix, PATH2, 'json', 'void', option),
      $put: (option: Methods2['put']['req'] & { init?: RequestInit }) =>
        send<Methods2['put']['res']>(PUT, prefix, PATH2, 'json', 'void', option),
      $delete: (option: Methods2['delete']['req'] & { init?: RequestInit }) =>
        send<Methods2['delete']['res']>(DELETE, prefix, PATH2, 'json', 'void', option),
    ...
    $get: (option: Methods0['get']['req'] & { init?: RequestInit }) =>
      send<{}>(GET, prefix, PATH0, 'void', 'void', option),
    $post: (option?: Methods0['post']['req'] & { init?: RequestInit }) =>
      send<{}>(POST, prefix, PATH0, 'void', 'void', option),
    ...
    $delete: (option: Methods0['delete']['req'] & { init?: RequestInit }) =>
      send<Methods0['delete']['res']>(DELETE, prefix, PATH0, 'json', 'void', option),
