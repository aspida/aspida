    ...
    api: {
      ...
      v1: {
        ...
        mixes: {
          ...
          post: (option?: { data?: Methods3['post']['reqData'], config?: T }) =>
            client.fetch<Methods3['post']['resData']>(prefix, '/api/v1/mixes', 'POST', option).json(),
          $post: async (option?: { data?: Methods3['post']['reqData'], config?: T }) =>
        ...
        parse: {
          ...
          post: (option?: { data?: Methods7['post']['reqData'], config?: T }) =>
            client.fetch<void>(prefix, '/api/v1/parse', 'POST', option).send(),
          $post: async (option?: { data?: Methods7['post']['reqData'], config?: T }) =>
            (await client.fetch<void>(prefix, '/api/v1/parse', 'POST', option).send()).data
        },
        token: {
          post: (option?: { data?: Methods9['post']['reqData'], config?: T }) =>
            client.fetch<Methods9['post']['resData']>(prefix, '/api/v1/token', 'POST', option).json(),
          $post: async (option?: { data?: Methods9['post']['reqData'], config?: T }) =>
            (await client.fetch<Methods9['post']['resData']>(prefix, '/api/v1/token', 'POST', option).json()).data
        }
      },
      v3: {
        $2fa: {
          post: (option: { data: Methods10['post']['reqData'], headers?: Methods10['post']['reqHeaders'], config?: T }) =>
            client.fetch<Methods10['post']['resData']>(prefix, '/api/v3/2fa', 'POST', option).json(),
          $post: async (option: { data: Methods10['post']['reqData'], headers?: Methods10['post']['reqHeaders'], config?: T }) =>
        ...
        channels: {
          _channelId: (val3: number | string) => ({
            chats: {
              _chatId: (val4: number | string) => ({
                items: {
                  _itemId: (val5: number | string) => ({
                    post: (option?: { data?: Methods16['post']['reqData'], headers?: Methods16['post']['reqHeaders'], config?: T }) =>
                      client.fetch<Methods16['post']['resData']>(prefix, `/api/v3/channels/${val3}/chats/${val4}/items/${val5}`, 'POST', option).json(),
                    $post: async (option?: { data?: Methods16['post']['reqData'], headers?: Methods16['post']['reqHeaders'], config?: T }) =>
                      (await client.fetch<Methods16['post']['resData']>(prefix, `/api/v3/channels/${val3}/chats/${val4}/items/${val5}`, 'POST', option).json()).data
                  }),
                  audio: {
                    post: (option?: { data?: Methods17['post']['reqData'], headers?: Methods17['post']['reqHeaders'], config?: T }) =>
                      client.fetch<Methods17['post']['resData']>(prefix, `/api/v3/channels/${val3}/chats/${val4}/items/audio`, 'POST', option, 'FormData').json(),
                    $post: async (option?: { data?: Methods17['post']['reqData'], headers?: Methods17['post']['reqHeaders'], config?: T }) =>
                  ...
                  image: {
                    post: (option?: { data?: Methods18['post']['reqData'], headers?: Methods18['post']['reqHeaders'], config?: T }) =>
                      client.fetch<Methods18['post']['resData']>(prefix, `/api/v3/channels/${val3}/chats/${val4}/items/image`, 'POST', option, 'FormData').json(),
                    $post: async (option?: { data?: Methods18['post']['reqData'], headers?: Methods18['post']['reqHeaders'], config?: T }) =>
                  ...
                  video: {
                    post: (option?: { data?: Methods19['post']['reqData'], headers?: Methods19['post']['reqHeaders'], config?: T }) =>
                      client.fetch<Methods19['post']['resData']>(prefix, `/api/v3/channels/${val3}/chats/${val4}/items/video`, 'POST', option, 'FormData').json(),
                    $post: async (option?: { data?: Methods19['post']['reqData'], headers?: Methods19['post']['reqHeaders'], config?: T }) =>
                  ...
                  post: (option: { data: Methods15['post']['reqData'], headers?: Methods15['post']['reqHeaders'], config?: T }) =>
                    client.fetch<Methods15['post']['resData']>(prefix, `/api/v3/channels/${val3}/chats/${val4}/items`, 'POST', option).json(),
                  $post: async (option: { data: Methods15['post']['reqData'], headers?: Methods15['post']['reqHeaders'], config?: T }) =>
                ...
                users: {
                  remove: {
                    post: (option: { data: Methods22['post']['reqData'], headers?: Methods22['post']['reqHeaders'], config?: T }) =>
                      client.fetch<void>(prefix, `/api/v3/channels/${val3}/chats/${val4}/users/remove`, 'POST', option).send(),
                    $post: async (option: { data: Methods22['post']['reqData'], headers?: Methods22['post']['reqHeaders'], config?: T }) =>
                  ...
                  post: (option: { data: Methods21['post']['reqData'], headers?: Methods21['post']['reqHeaders'], config?: T }) =>
                    client.fetch<void>(prefix, `/api/v3/channels/${val3}/chats/${val4}/users`, 'POST', option).send(),
                  $post: async (option: { data: Methods21['post']['reqData'], headers?: Methods21['post']['reqHeaders'], config?: T }) =>
                    (await client.fetch<void>(prefix, `/api/v3/channels/${val3}/chats/${val4}/users`, 'POST', option).send()).data,
                  put: (option: { data: Methods21['put']['reqData'], headers?: Methods21['put']['reqHeaders'], config?: T }) =>
                    client.fetch<void>(prefix, `/api/v3/channels/${val3}/chats/${val4}/users`, 'PUT', option).send(),
                  $put: async (option: { data: Methods21['put']['reqData'], headers?: Methods21['put']['reqHeaders'], config?: T }) =>
                ...
                put: (option: { data: Methods14['put']['reqData'], headers?: Methods14['put']['reqHeaders'], config?: T }) =>
                  client.fetch<void>(prefix, `/api/v3/channels/${val3}/chats/${val4}`, 'PUT', option).send(),
                $put: async (option: { data: Methods14['put']['reqData'], headers?: Methods14['put']['reqHeaders'], config?: T }) =>
              ...
              post: (option: { data: Methods13['post']['reqData'], headers?: Methods13['post']['reqHeaders'], config?: T }) =>
                client.fetch<Methods13['post']['resData']>(prefix, `/api/v3/channels/${val3}/chats`, 'POST', option).json(),
              $post: async (option: { data: Methods13['post']['reqData'], headers?: Methods13['post']['reqHeaders'], config?: T }) =>
          ...
          _chatId: (val6: number | string) => ({
            items: {
              _itemId: (val7: number | string) => ({
                post: (option?: { data?: Methods26['post']['reqData'], headers?: Methods26['post']['reqHeaders'], config?: T }) =>
                  client.fetch<Methods26['post']['resData']>(prefix, `/api/v3/chats/${val6}/items/${val7}`, 'POST', option).json(),
                $post: async (option?: { data?: Methods26['post']['reqData'], headers?: Methods26['post']['reqHeaders'], config?: T }) =>
              ...
              post: (option: { data: Methods25['post']['reqData'], headers?: Methods25['post']['reqHeaders'], config?: T }) =>
                client.fetch<Methods25['post']['resData']>(prefix, `/api/v3/chats/${val6}/items`, 'POST', option).json(),
              $post: async (option: { data: Methods25['post']['reqData'], headers?: Methods25['post']['reqHeaders'], config?: T }) =>
        ...
        login: {
          post: (option: { data: Methods41['post']['reqData'], headers?: Methods41['post']['reqHeaders'], config?: T }) =>
            client.fetch<Methods41['post']['resData']>(prefix, '/api/v3/login', 'POST', option).json(),
          $post: async (option: { data: Methods41['post']['reqData'], headers?: Methods41['post']['reqHeaders'], config?: T }) =>
            (await client.fetch<Methods41['post']['resData']>(prefix, '/api/v3/login', 'POST', option).json()).data
        },
        logout: {
          post: (option: { data: Methods42['post']['reqData'], headers?: Methods42['post']['reqHeaders'], config?: T }) =>
            client.fetch<void>(prefix, '/api/v3/logout', 'POST', option).send(),
          $post: async (option: { data: Methods42['post']['reqData'], headers?: Methods42['post']['reqHeaders'], config?: T }) =>
