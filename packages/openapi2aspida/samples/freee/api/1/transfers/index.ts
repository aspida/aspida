...
export default mockMethods<Methods>({
  ...
  post: () => ({ status: 200, resBody: { transfer: { id: 1, company_id: 1, amount: 1, date: 'a', from_walletable_type: 'bank_account', from_walletable_id: 1, to_walletable_type: 'bank_account', to_walletable_id: 1, description: 'a' } } })
})
