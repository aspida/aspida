  ...
  return {
    ...
    users: {
      _id: (val4: number | string) => ({
        ...
        put: (option: { data: Methods15['put']['reqData'], config?: T }) =>
          client.fetch<Methods15['put']['resData']>(prefix, `/users/${val4}`, 'PUT', option).json(),
        $put: async (option: { data: Methods15['put']['reqData'], config?: T }) =>
    ...
    users_permissions: {
      ...
      roles: {
        ...
        _role: (val6: number | string) => ({
          put: (option: { data: Methods20['put']['reqData'], config?: T }) =>
            client.fetch<Methods20['put']['resData']>(prefix, `/users-permissions/roles/${val6}`, 'PUT', option).json(),
          $put: async (option: { data: Methods20['put']['reqData'], config?: T }) =>
        ...
        post: (option: { data: Methods18['post']['reqData'], config?: T }) =>
          client.fetch<Methods18['post']['resData']>(prefix, '/users-permissions/roles', 'POST', option).json(),
        $post: async (option: { data: Methods18['post']['reqData'], config?: T }) =>
