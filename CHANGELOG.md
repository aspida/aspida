...
### [1.9.1](https://github.com/aspida/aspida/compare/v1.9.0...v1.9.1) (2022-03-22)


### Refactors

* refactor: refactor about eslint-disable and prettier-ignore directive comments (https://github.com/aspida/aspida/pull/739)
...
* **swrv:** revert accidentally dropped API `enabled` (https://github.com/aspida/aspida/pull/727)

### [1.8.0](https://github.com/aspida/aspida/compare/v1.7.1...v1.8.0) (2022-02-24)


### Features

* **aspida:** use only type-only imports for types (https://github.com/aspida/aspida/pull/712)
