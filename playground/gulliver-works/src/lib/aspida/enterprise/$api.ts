...
const api = <T>({ baseURL, fetch }: AspidaClient<T>) => {
  ...
  const PATH6 = '/rooms'
  const PATH7 = '/profile'
  const PATH8 = '/industryCategories'
  const PATH9 = '/messages'
  const PATH10 = '/occupationMainCategories'
      ...
      _companyId: (val1: string) => {
        ...
        return {
          applicants: {
             ...
             */
            $get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods2['get']['resBody'], BasicHeaders, Methods2['get']['status']>(prefix, `${prefix1}${PATH0}`, GET, option).json().then(r => r.body),
          ...
          recruitments: {
             ...
             */
            $get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods6['get']['resBody'], BasicHeaders, Methods6['get']['status']>(prefix, `${prefix1}${PATH5}`, GET, option).json().then(r => r.body),
            /**
             * @returns Created
             */
      ...
      _employeeId: (val1: string) => {
        ...
        return {
          profile: {
            ...
            $get: (option?: { config?: T | undefined } | undefined) =>
              fetch(prefix, `${prefix1}${PATH7}`, GET, option).send().then(r => r.body),
            /**
             * @returns OK
             */
             ...
             */
            $patch: (option: { body: Methods9['patch']['reqBody'], config?: T | undefined }) =>
              fetch<Methods9['patch']['resBody'], BasicHeaders, Methods9['patch']['status']>(prefix, `${prefix1}${PATH7}`, PATCH, option).json().then(r => r.body),
            ...
            $post: (option: { body: Methods9['post']['reqBody'], config?: T | undefined }) =>
              fetch<void, BasicHeaders, Methods9['post']['status']>(prefix, `${prefix1}${PATH7}`, POST, option).send().then(r => r.body),
    ...
    recruitments: {
      _id: (val1: string) => {
        ...
        return {
           ...
           */
          $patch: (option: { body: Methods15['patch']['reqBody'], config?: T | undefined }) =>
            fetch<Methods15['patch']['resBody'], BasicHeaders, Methods15['patch']['status']>(prefix, prefix1, PATCH, option).json().then(r => r.body),
          $path: () => `${prefix}${prefix1}`
        }
      },
      _recruitmentId: (val1: string) => {
        ...
        return {
          applicants: {
             ...
             */
            $get: (option?: { query?: Methods16['get']['query'] | undefined, config?: T | undefined } | undefined) =>
              fetch<Methods16['get']['resBody'], BasicHeaders, Methods16['get']['status']>(prefix, `${prefix1}${PATH0}`, GET, option).json().then(r => r.body),
    ...
    rooms: {
      _id: (val1: string) => {
        ...
        return {
           ...
           */
          $get: (option?: { config?: T | undefined } | undefined) =>
            fetch<Methods17['get']['resBody'], BasicHeaders, Methods17['get']['status']>(prefix, prefix1, GET, option).json().then(r => r.body),
          $path: () => `${prefix}${prefix1}`
        }
      },
      _roomId: (val1: string) => {
        ...
        return {
          messages: {
             ...
             */
            $get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods18['get']['resBody'], BasicHeaders, Methods18['get']['status']>(prefix, `${prefix1}${PATH9}`, GET, option).json().then(r => r.body),
            /**
             * @returns Created
             */
             ...
             */
            $post: (option: { body: Methods18['post']['reqBody'], config?: T | undefined }) =>
              fetch<Methods18['post']['resBody'], BasicHeaders, Methods18['post']['status']>(prefix, `${prefix1}${PATH9}`, POST, option).json().then(r => r.body),
